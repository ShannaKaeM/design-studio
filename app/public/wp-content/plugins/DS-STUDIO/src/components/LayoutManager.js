...
const LayoutManager = () => {
    ...
    return (
        <div className="ds-layout-manager">
            <h4>{__('Layout Settings', 'ds-studio')}</h4>
            
            <TextControl
                label={__('Content Size', 'ds-studio')}
                value={contentSize}
                onChange={handleContentSizeChange}
                help={__('Maximum width for regular content blocks', 'ds-studio')}
            />
            
            <TextControl
                label={__('Wide Size', 'ds-studio')}
                value={wideSize}
                onChange={handleWideSizeChange}
                help={__('Maximum width for wide-aligned blocks', 'ds-studio')}
            />

            <div className="ds-layout-preview">
                <h5>{__('Layout Preview', 'ds-studio')}</h5>
                <div style={{ 
