    ...
    return (
        <div className="ds-spacing-manager">
            ...
            <div className="ds-spacing-presets">
                <h4>{__('Quick Start', 'ds-studio')}</h4>
                <Flex>
                    <FlexItem>
                        <Button
                            isSecondary
            ...
            <div className="ds-add-spacing">
                <h4>{__('Add New Spacing', 'ds-studio')}</h4>
                
                <TextControl
                    label={__('Spacing Name', 'ds-studio')}
                ...
                >
                    {__('Add Spacing', 'ds-studio')}
                </Button>
            </div>

            {/* Spacing Scale */}
            <div className="ds-spacing-scale">
                <h4>{__('Spacing Scale', 'ds-studio')}</h4>
                
                {spacingSizes.length === 0 && (
                    <Notice status="info" isDismissible={false}>
                        {__('No spacing sizes defined. Add your first spacing above or load a preset.', 'ds-studio')}
                    </Notice>
                )}
            ...
            {spacingSizes.length > 0 && (
                <div className="ds-css-preview">
                    <h4>{__('Generated CSS Variables', 'ds-studio')}</h4>
