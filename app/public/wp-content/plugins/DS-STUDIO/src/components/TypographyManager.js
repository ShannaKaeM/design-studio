    ...
    return (
        <div className="ds-typography-manager">
            <div className="ds-font-size-presets">
                <h4>{__('Font Size Presets', 'ds-studio')}</h4>
                <Button
                    isSecondary
                    onClick={() => loadFontSizePreset('modern')}
                >
                    {__('Modern Scale', 'ds-studio')}
                </Button>
            </div>

            <div className="ds-font-sizes">
                <h4>{__('Font Sizes', 'ds-studio')}</h4>
                {fontSizes.length === 0 && (
                    <Notice status="info" isDismissible={false}>
                        {__('No font sizes defined. Load a preset to get started.', 'ds-studio')}
                    </Notice>
                )}
