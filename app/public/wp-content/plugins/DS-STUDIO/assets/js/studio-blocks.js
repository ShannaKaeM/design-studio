...
(function() {
    ...
    const StudioSpacingPicker = function({ label, value, tokens, onChange, single = false }) {
        ...
        return el(BaseControl, { label: label, className: 'studio-spacing-picker' },
            el('p', {}, __('Multi-side spacing coming soon', 'ds-studio'))
        );
    };
    ...
    const StudioContainerEdit = function(props) {
        ...
        return el('div', {},
            ...
            el(InspectorControls, {},
                el(PanelBody, { title: __('Background', 'ds-studio'), initialOpen: true },
                ...
                el(PanelBody, { title: __('Layout', 'ds-studio'), initialOpen: false },
                    el(SelectControl, {
