...
class Studio_GenerateBlocks_Integration {
    ...
    public function ajax_get_utilities_by_category() {
        ...
        if (!class_exists('Studio_Utility_Generator')) {
            wp_send_json_error('Utility generator not available');
            return;
        }
        
        $utility_generator = new Studio_Utility_Generator();
...
new Studio_GenerateBlocks_Integration();
