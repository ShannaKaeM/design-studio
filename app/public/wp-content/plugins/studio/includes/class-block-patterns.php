...
class Studio_Block_Patterns {
    ...
    private function register_hero_patterns() {
        ...
        register_block_pattern('ds-studio/hero-background', array(
            'title' => __('Hero with Background', 'studio'),
            'description' => __('Full-width hero section with background color and centered content', 'studio'),
...
<!-- /wp:group -->'
        ...
        register_block_pattern('ds-studio/hero-split', array(
            'title' => __('Hero Split Layout', 'studio'),
            'description' => __('Two-column hero with content and image', 'studio'),
            'categories' => array('ds-studio-hero'),
...
<!-- /wp:columns -->'
    ...
    private function register_content_patterns() {
        ...
        register_block_pattern('ds-studio/feature-grid', array(
            'title' => __('Feature Grid', 'studio'),
            'description' => __('Three-column feature grid with icons and descriptions', 'studio'),
...
<!-- /wp:group -->'
    ...
    private function register_card_patterns() {
        ...
        register_block_pattern('ds-studio/product-cards', array(
            'title' => __('Product Cards', 'studio'),
            'description' => __('Product showcase cards with pricing', 'studio'),
...
<!-- /wp:columns -->'
    ...
    private function register_layout_patterns() {
        ...
        register_block_pattern('ds-studio/content-sidebar', array(
            'title' => __('Content with Sidebar', 'studio'),
            'description' => __('Two-column layout with main content and sidebar', 'studio'),
...
<!-- /wp:columns -->'
    ...
    private function register_cta_patterns() {
        ...
        register_block_pattern('ds-studio/cta-banner', array(
            'title' => __('CTA Banner', 'studio'),
            'description' => __('Call-to-action banner with gradient background', 'studio'),
