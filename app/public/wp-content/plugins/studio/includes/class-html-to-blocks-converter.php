...
class Studio_HTML_To_Blocks_Converter {
    
    private $component_mapping = [
        'featured-attractions-section' => 'core/group',
        'section-header' => 'core/group',
        'section-badge' => 'core/paragraph',
        'section-title' => 'core/heading',
        'section-subtitle' => 'core/paragraph',
        'attractions-grid' => 'core/columns',
        'attraction-card' => 'core/column',
        'attraction-image-container' => 'core/group',
        'attraction-image' => 'core/image',
        'attraction-overlay' => 'core/group',
        'attraction-badge' => 'core/paragraph',
        'attraction-content' => 'core/group',
        'attraction-name' => 'core/heading',
        'attraction-location' => 'core/paragraph',
        'attraction-button' => 'core/button',
        // Legacy mappings
    ...
    private $component_css = [
        'featured-attractions-section' => 'padding: 3rem 1.5rem; background-color: var(--wp--preset--color--extreme-light);',
        'section-header' => 'text-align: center; margin-bottom: 3rem; max-width: 600px; margin-left: auto; margin-right: auto;',
        'section-badge' => 'font-size: 0.75rem; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase; color: var(--wp--preset--color--primary); margin-bottom: 0.5rem;',
        'section-title' => 'font-family: var(--wp--preset--font-family--montserrat); font-size: 2.5rem; font-weight: 700; color: var(--wp--preset--color--base-darkest); margin: 0 0 1rem 0; line-height: 1.2;',
        'section-subtitle' => 'font-family: var(--wp--preset--font-family--montserrat); font-size: 1.125rem; color: var(--wp--preset--color--base); margin: 0;',
        'attractions-grid' => 'display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; max-width: 1280px; margin: 0 auto;',
        'attraction-card' => 'position: relative; border-radius: var(--wp--custom--layout--borderRadius--lg); overflow: hidden; aspect-ratio: 4/3; background-color: var(--wp--preset--color--base-light); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer;',
        'attraction-image-container' => 'position: relative; width: 100%; height: 100%;',
        'attraction-image' => 'width: 100%; height: 100%; object-fit: cover; position: absolute; top: 0; left: 0;',
        'attraction-overlay' => 'position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: linear-gradient(to top, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.1) 100%); z-index: 10;',
        'attraction-badge' => 'position: absolute; top: 1rem; right: 1rem; z-index: 20; font-size: 0.75rem; font-weight: 500; padding: 0.25rem 0.5rem; border-radius: 0.5rem; backdrop-filter: blur(8px); text-transform: uppercase; letter-spacing: 0.025em;',
        'badge-primary-light' => 'background: rgba(90, 123, 124, 0.1); color: var(--wp--preset--color--primary-dark); border: 1px solid rgba(90, 123, 124, 0.2);',
        'badge-neutral-light' => 'background: rgba(179, 176, 159, 0.1); color: var(--wp--preset--color--neutral-dark); border: 1px solid rgba(179, 176, 159, 0.2);',
        'attraction-content' => 'position: absolute; bottom: 0; left: 0; right: 0; padding: 1.5rem; z-index: 20;',
        'attraction-name' => 'font-family: var(--wp--preset--font-family--montserrat); font-size: 1.25rem; font-weight: 600; color: var(--wp--preset--color--extreme-light); margin: 0 0 0.25rem 0; line-height: 1.3;',
        'attraction-location' => 'font-family: var(--wp--preset--font-family--montserrat); font-size: 0.875rem; color: rgba(255, 255, 255, 0.8); margin: 0 0 1rem 0;',
        'attraction-button' => 'display: inline-flex; align-items: center; padding: 0.5rem 1rem; font-size: 0.875rem; font-weight: 500; font-family: var(--wp--preset--font-family--montserrat); color: var(--wp--preset--color--extreme-light); background-color: transparent; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 0.5rem; text-decoration: none; transition: all 0.3s ease; backdrop-filter: blur(8px);',
        // Legacy CSS
...
new Studio_HTML_To_Blocks_Converter();
