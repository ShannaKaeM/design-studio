    ...
    return (
        <BaseControl label={label} className="studio-typography-picker">
            ...
            <div className="studio-typography-control">
                <SelectControl
                    label={__('Font Family', 'studio')}
                    value={currentValue.fontFamily || ''}
                    options={[
                        { label: __('Default', 'studio'), value: '' },
            ...
            {/* Font Size */}
            <div className="studio-typography-control">
                <label className="studio-typography-label">{__('Font Size', 'studio')}</label>
                <ButtonGroup>
            ...
            {/* Font Weight */}
            <div className="studio-typography-control">
                <label className="studio-typography-label">{__('Font Weight', 'studio')}</label>
                <ButtonGroup>
            ...
            {/* Line Height */}
            <div className="studio-typography-control">
                <label className="studio-typography-label">{__('Line Height', 'studio')}</label>
                <ButtonGroup>
