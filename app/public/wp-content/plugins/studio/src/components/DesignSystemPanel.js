...
const DesignSystemPanel = () => {
    ...
    const panels = [
        { key: 'colors', title: __('Colors', 'studio'), component: ColorManager },
        { key: 'spacing', title: __('Spacing', 'studio'), component: SpacingManager },
        { key: 'typography', title: __('Typography', 'studio'), component: TypographyManager },
        { key: 'layout', title: __('Layout', 'studio'), component: LayoutManager },
        { key: 'export', title: __('Export/Import', 'studio'), component: ExportImport }
    ];
    ...
    return (
        <div className="ds-design-system-panel">
            <div className="ds-panel-header">
                <h3>{__('Design System Studio', 'studio')}</h3>
                <p>{__('Visual theme.json management with live preview', 'studio')}</p>
            </div>
            ...
            <div className="ds-global-actions">
                <Button
                    ...
                    style={{ width: '100%' }}
                >
                    {isLoading ? __('Saving...', 'studio') : __('Save All Changes', 'studio')}
                </Button>
            </div>
            ...
            <div className="ds-preview-status">
                <Notice status="info" isDismissible={false}>
                    {__('Changes are previewed live in the editor. Click "Save All Changes" to write to theme.json file.', 'studio')}
                </Notice>
            </div>
        </div>
    );
