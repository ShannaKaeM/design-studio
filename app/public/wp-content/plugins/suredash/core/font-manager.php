...
final class FontManager {
	 ...
	 * @return void
	 */
	public function process_fonts( $font_family = null ): void {
	...
	public function get_fonts_file_url( $font_family, $font_weight, $font_style ) {
		...
		$local_css = preg_replace(  // Replace remote URLs with local URLs.
			'/https:\/\/fonts.gstatic.com\/s\/[^)]+\)(.*?)format\([\'"].*?[\'"]\)/',
			$this->base_url . $fonts_file_name_final . ') format(\'' . $this->font_format . '\')',
